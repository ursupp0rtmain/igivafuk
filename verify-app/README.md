...
> A structured project built with igivafuk.

Built with [igivafuk](https://idontgivaf.uk) — Structure over slop.

You said you didn't give a f***. Turns out you do. Good.

## About

Verify App is a structured project for AI-assisted development. Agents follow rules in `AGENTS.md`; humans follow `CONTRIBUTING.md`. Every change is tracked in `CHANGELOG.md`.
...
- [igivafuk](https://idontgivaf.uk) — structure over slop
